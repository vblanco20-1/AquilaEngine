...
bool LoadContent()
{
	...
	vertexBufferDesc.ByteWidth = sizeof(VertexPosColor) * _countof(g_CubeVertices);
	...
	resourceData.pSysMem = g_CubeVertices;
	...
	indexBufferDesc.ByteWidth = sizeof(WORD) * _countof(g_CubeIndicies);
	indexBufferDesc.CPUAccessFlags = 0;
	indexBufferDesc.Usage = D3D11_USAGE_DEFAULT;
	resourceData.pSysMem = g_CubeIndicies;
